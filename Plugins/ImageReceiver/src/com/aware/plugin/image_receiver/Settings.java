...
public class Settings extends Activity {
    private final static String TAG = ContextophelesConstants.TAG_IMAGE_RECEIVER + " Settings";
    private static TextView countView = null;
    private static Uri contentUri = ImageReceiver_Provider.ImageReceiver.CONTENT_URI;
