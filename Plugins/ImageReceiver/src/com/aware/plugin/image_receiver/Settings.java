...
public class Settings extends Activity {
    private final static String TAG = "ImageReceiver Settings";
    
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        IntentFilter clipboard_filter = new IntentFilter();
        clipboard_filter.addAction(Plugin.ACTION_AWARE_IMAGERECEIVER);
...
//        content.setText(Plugin.currentClipboardContent);
    ...
    public static class ClipboardReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if( intent.getAction().equals(Plugin.ACTION_AWARE_IMAGERECEIVER)) {
        		Log.d(TAG,"Action");
//        		content.setText(intent.getStringExtra(Plugin.EXTRA_CLIPBOARDCONTENT));
    ...
    public void updateCount() {
    	Cursor countCursor = getContentResolver().query(ImageReceiver_Provider.ImageReceiver.CONTENT_URI,
