...
public class Settings extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clipboard_filter.addAction(Plugin.ACTION_AWARE_TERMCOLLECTOR);
...
//        content.setText(Plugin.currentClipboardContent);
    ...
    public static class ClipboardReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if( intent.getAction().equals(Plugin.ACTION_AWARE_TERMCOLLECTOR)) {
        		Log.d(TAG,"Action");
        		content.setText(intent.getStringExtra(Plugin.EXTRA_TERMCONTENT));
            }
        }
    }
    ...
    public void updateCount() {
    	Cursor countCursor = getContentResolver().query(TermCollector_Provider.TermCollector.CONTENT_URI,
