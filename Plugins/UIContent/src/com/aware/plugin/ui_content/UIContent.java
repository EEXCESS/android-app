...
public class UIContent extends AccessibilityService {		
	...
	public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        switch (event.getEventType()){
            ...
            case(AccessibilityEvent.TYPE_VIEW_SELECTED): Log.d(TAG, "TYPE_VIEW_SELECTED");
                Log.d(TAG, "Source: "  + event.getSource());

                break;
            case(AccessibilityEvent.TYPE_VIEW_FOCUSED): Log.d(TAG, "TYPE_VIEW_FOCUSED");
            ...
            case(AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED): Log.d(TAG, "TYPE_WINDOW_STATE_CHANGED");
                //getUIContentFromNode(event.getSource());
                break;
            case(AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED): Log.d(TAG, "TYPE_NOTIFICATION_STATE_CHANGED"); break;
            ...
            case(AccessibilityEvent.TYPE_WINDOW_CONTENT_CHANGED): Log.d(TAG, "TYPE_WINDOW_CONTENT_CHANGED");
                getUIContentFromNode(event.getSource());
                break;
            case(AccessibilityEvent.TYPE_VIEW_SCROLLED): Log.d(TAG, "TYPE_VIEW_SCROLLED");
              //  getUIContentFromNode(event.getSource());
                break;
