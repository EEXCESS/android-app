...
//        out.writeStringList(title);
//        out.writeString(link);
//        out.writeString(guid);
//
//        out.writeString(type);
//        out.writeStringList(year);
//        out.writeStringList(language);
//        out.writeStringList(provider);
//        out.writeStringList(dataProvider);
//        out.writeStringList(rights);
//
//        out.writeList(edmConceptLabel);
//        out.writeList(edmTimespanLabel);
//
//        out.writeStringList(europeanaCollectionName);
//        out.writeStringList(dcCreator);
//
//        out.writeString(id);
//        out.writeInt(completeness);
//
//        out.writeStringList(edmPreview);
//    }
//
//    private EuropeanaApi2Item(Parcel in) {
...
//        in.readStringList(language);
//        this.provider = new ArrayList<String>();
//        in.readStringList(provider);
//        this.dataProvider = new ArrayList<String>();
//        in.readStringList(dataProvider);
//        this.rights = new ArrayList<String>();
//        in.readStringList(rights);
//
//
//        this.edmConceptLabel = new ArrayList<Map<String, String>>();
//        in.readArrayList(ArrayList<Map<String, String>>.getClass());
//
//        out.writeList(edmConceptLabel);
//        out.writeList(edmTimespanLabel);
//
...
//    }
//
//    public static final Parcelable.Creator<EuropeanaApi2Item> CREATOR
//            = new Parcelable.Creator<EuropeanaApi2Item>() {
//        public EuropeanaApi2Item createFromParcel(Parcel in) {
//            return new EuropeanaApi2Item(in);
//        }
//
//        public EuropeanaApi2Item[] newArray(int size) {
//            return new EuropeanaApi2Item[size];
//        }
//    };
}
